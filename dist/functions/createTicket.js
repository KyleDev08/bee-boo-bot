...
export default async function (guild, user, guildDoc, reason) {
    const embedWelcome = new EmbedBuilder()
        ...
        .setColor("Green")
        .setThumbnail("https://media.discordapp.net/attachments/797507077873336382/1412094672767029268/file_000000009920622fafea285d131e9ed7.png")
        .setFooter({
        text: guild?.name || guild?.client.user.username || "Ticket System",
        iconURL: guild?.iconURL() || guild?.client.user.avatarURL() || undefined,
    })
        .setTimestamp();
    const rowTicket = new ActionRowBuilder().addComponents(new ButtonBuilder()
    ...
    if (!me)
        throw new Error("El bot no está en el servidor");
    ...
    for (const roleId of guildDoc.roles) {
